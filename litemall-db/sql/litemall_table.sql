...
--
-- Table structure for table `litemall_sensitive_word`
--

DROP TABLE IF EXISTS `litemall_sensitive_word`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `litemall_sensitive_word` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `enabled` (`enabled`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COMMENT='敏感词表';
/*!40101 SET character_set_client = @saved_cs_client */;
